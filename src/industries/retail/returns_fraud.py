...
def _process(state: State) -> State:
    logger.info("Processing", module="Returns Fraud")
    return {**state, "output": "Stub output for Returns Fraud", "_tokens_used": state.get("_tokens_used", 0) + 200}
