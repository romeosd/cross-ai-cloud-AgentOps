...
def _process(state: State) -> State:
    logger.info("Processing", module="Wealth Advisory")
    return {**state, "output": "Stub output for Wealth Advisory", "_tokens_used": state.get("_tokens_used", 0) + 200}
