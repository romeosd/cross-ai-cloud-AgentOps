...
def _process(state: State) -> State:
    logger.info("Processing", module="Fraud Detection")
    return {**state, "output": "Stub output for Fraud Detection", "_tokens_used": state.get("_tokens_used", 0) + 200}
