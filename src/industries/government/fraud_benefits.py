...
def _process(state: State) -> State:
    logger.info("Processing", module="Fraud Benefits")
    return {**state, "output": "Stub output for Fraud Benefits", "_tokens_used": state.get("_tokens_used", 0) + 200}
