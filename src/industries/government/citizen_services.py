...
def _process(state: State) -> State:
    logger.info("Processing", module="Citizen Services")
    return {**state, "output": "Stub output for Citizen Services", "_tokens_used": state.get("_tokens_used", 0) + 200}
