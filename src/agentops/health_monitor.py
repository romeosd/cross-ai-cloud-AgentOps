...
def _process(state: State) -> State:
    logger.info("Processing", module="Health Monitor")
    return {**state, "output": "Stub output for Health Monitor", "_tokens_used": state.get("_tokens_used", 0) + 200}
